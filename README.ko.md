...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092183407778509243"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 059 예시 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092183407778509243"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 059 예시 2"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 059 예시 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 059 예시 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 059 예시 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 059 예시 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 059 추가 상하 예시 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 059 추가 상하 예시 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 059 추가 상하 예시 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 059 추가 상하 예시 4"></td>
  </tr>
</table>

> [샤오샤오둥（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2092183407778509243) · 2026년 8월 25일<br>
> GPT2 × 그림책 × 동심 × 일러스트레이션 × 미학 프롬프트 × VOL.059

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2092183407778509243">원문 게시물과 전체 프롬프트 보기 →</a></p>

이 예시는 059의 미학적 결과만 보여 줍니다. 예시의 주제, 구성, 색상, 문구, 이전 캔버스 비율은 새 작업의 참고나 기본값이 되지 않습니다.

손그림 서사 · 동심의 은유 · 따뜻한 종이 질감 · 가벼운 유머 · 시적인 방백

사진에서 가장 기억에 남는 주체, 몸짓, 관계와 감정을 골라 현실을 짧은 여행 우화나 개인적인 신화로 다시 들려줍니다. 과슈, 파스텔, 색연필, 크레용 같은 종이 질감에 절제된 여백과 순진한 유머를 더해 그림책의 온기와 세련된 편집 디자인의 질서를 함께 만듭니다.
...
**Panel 059**은 원본 사진의 핵심을 보존하면서 다음과 같은 시각 방향을 원하는 작업에 적합합니다: **사진 속 말하지 못한 이야기를 따뜻하고 천진하며 영리한 우화 그림책으로**. 먼저 용도와 원하는 결과를 확인한 뒤 구성, 크기, 텍스트와 전달 형식을 결정합니다.
...
> XXD Panel 059으로 이 이미지를 작업하고, 먼저 가장 어울리는 구성과 크기를 추천해 줘.
...
## 빠른 판단: XXD Panel 059이 나에게 맞을까요?

| 궁금한 점 | 이 스타일이 주는 답 |
|---|---|
| **얻게 되는 결과** | 사진 속 말하지 못한 이야기를 따뜻하고 천진하며 영리한 우화 그림책으로 |
| **한눈에 알아볼 특징** | 손그림 서사 · 동심의 은유 · 따뜻한 종이 질감 · 가벼운 유머 · 시적인 방백 |
...
사진의 핵심 이미지와 숨은 뜻, 분위기를 이해한 뒤 가장 식별하기 쉬운 주체, 윤곽, 몸짓과 공간 관계만 남깁니다. 과장된 비례, 의인화, 은유적 풍경을 사용할 수 있지만 모두 하나의 중심 주제를 섬기며 무관한 귀여운 요소를 쌓지 않습니다.

```text
정체성·윤곽·몸짓 고정 → 숨은 뜻·분위기·함의 이해 → 서사에 필요 없는 현실 세부 삭제 → 과장된 비례·의인화·은유적 풍경으로 관계 재서술 → 옅은 여백과 곡선 깊이에서 작은 환상 성장 → 과슈·파스텔·색연필·크레용의 따뜻함으로 채색 → 시적인 메모나 영리한 방백 통합
```

## 완성작에서 바로 알아볼 수 있는 스타일 특징

- 가장 본질적이고 기억에 남는 이미지 관계만 남겨 원본을 알아볼 수 있게 하면서 숨은 감정과 의미를 드러냅니다.
- 조금 서툰 윤곽, 부드러운 색면, 자연 재료 질감과 작은 손작업 오차가 상업적이지 않은 다정한 그림책 표면을 만듭니다.
- 과장된 비례, 의인화, 반복 기호와 은유적 풍경이 원본 주제를 벗어나지 않으면서 동심과 가벼운 유머를 더합니다.
- 옅은 핑크 블루, 안개빛 파랑, 크림, 연한 베이지, 부드러운 회녹색과 소량의 블러시가 맑고 치유적인 공기를 유지합니다.
- 주체는 중하단이나 서사적 긴장점에 놓이며, 시적인 메모는 직설적 설명이 아니라 영리한 방백으로 여백에 들어갑니다.

미적 제약과 금지 항목은 [원본 프롬프트](references/original-prompt/zh-CN.md)에만 있으며 Skill과 런타임 어댑터는 이번 출력 변수만 처리합니다. [Skill](SKILL.md) · [영문 런타임 어댑터](references/xxd-panel-059-prompt.en.md)
...
이미지 폴더를 직접 전달하면 이 병사 Skill이 같은 Panel 059의 원본 미학으로 일괄 처리합니다. 일반 래스터 형식을 기본적으로 재귀 탐색하고 수량을 먼저 알린 뒤 모드·크기·텍스트·언어를 한 번만 확인합니다. 각 이미지는 내용이나 문구가 섞이지 않도록 독립 생성하며 전체 배치는 하나의 평면 작업 디렉터리만 사용합니다. 개별 실패는 기록하고 이후 이미지를 조용히 누락하지 않습니다.
...
/xxd-panel-059 photo.jpg --mode top-bottom --size auto --text prompt --locale ko-KR

# 좌우 비교: 3:2 가로형, 글자 없음
/xxd-panel-059 photo.jpg --mode left-right --size 3:2 --text none

# 디자인 전용: 9:16 휴대폰 세로형, 한국어 문구
/xxd-panel-059 photo.jpg --mode design-only --size 9:16 --text prompt --locale ko-KR
...
/xxd-panel-059 photo.jpg --mode design-only --size 3:4 --text prompt --locale ko-KR

# 정확한 문구를 재작성·번역·제목 추가 없이 사용
/xxd-panel-059 photo.jpg --mode design-only --size 3:4 --copy "빛을 이곳에 남겨 두기" --locale ko-KR

# 2개 모드 × 3개 크기로 독립적인 완성 구도 6개 생성
/xxd-panel-059 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ko-KR

# 폴더 전체에 Panel 059 적용, 공통 설정은 한 번만 확정
/xxd-panel-059 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ko-KR
...
Claude Code 사용자는 같은 폴더를 다음 위치에 연결할 수 있습니다: `~/.claude/skills/xxd-panel-059`. 설치 후 에이전트 세션을 다시 시작하세요.
