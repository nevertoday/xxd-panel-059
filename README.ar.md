...
### تحويل قصة الصورة غير المنطوقة إلى حكاية مصوّرة دافئة وطفولية وذكية
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092183407778509243"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 059 نموذج 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092183407778509243"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 059 نموذج 2"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 059 نموذج 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 059 نموذج 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 059 نموذج 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 059 نموذج 8"></td>
  </tr>
</table>

## نماذج إضافية 3:4 بتكوين أعلى–أسفل

تعيد هذه الأعمال الأربعة استخدام المصادر المستقلة نفسها في مجموعة 16:9 أعلاه، لكن داخل لوحات كاملة 3:4 بتكوين أعلى–أسفل. تبقى الصورة الواقعية في الأعلى، ويُعاد بناء التصميم السفلي وفق الموجّه الأصلي لـ Panel 059. لا يُولَّد النص الإنجليزي إلا من محتوى كل صورة أو مزاجها أو دلالتها، وقد روجعت النتائج واحدةً واحدة.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 059 نموذج إضافي أعلى–أسفل 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 059 نموذج إضافي أعلى–أسفل 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 059 نموذج إضافي أعلى–أسفل 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 059 نموذج إضافي أعلى–أسفل 4"></td>
  </tr>
</table>

> [Xiaoxiaodong (@xiaoxiaodong01)](https://x.com/xiaoxiaodong01/status/2092183407778509243) · 25 أغسطس 2026<br>
> GPT2 × كتاب مصوّر × براءة طفولية × رسم توضيحي × موجّه جمالي × VOL.059

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2092183407778509243">عرض المنشور الأصلي والتوجيه كاملاً ←</a></p>

تعرض هذه النماذج النتيجة الجمالية للإصدار 059 فقط؛ ولا تصبح موضوعاتها أو تكوينها أو ألوانها أو نصوصها أو نسبة اللوحة السابقة مراجع أو إعدادات افتراضية لمهمة جديدة.

سرد مرسوم يدوياً · استعارة طفولية · ورق دافئ · فكاهة رقيقة · تعليق شاعري

يختار من الصورة موضوعها وحركتها وعلاقتها وشعورها الأشد بقاءً في الذاكرة، ثم يعيد سرد الواقع كحكاية سفر صغيرة أو أسطورة شخصية. تجتمع خامات الغواش والباستيل والقلم والطباشير على الورق مع فراغ مضبوط ولمسة من الفكاهة البريئة، فتبدو النتيجة ككتاب مصوّر منظم بروح تصميم تحريري راقٍ.
...
يناسب **Panel 059** الأعمال التي تحتاج إلى الاحتفاظ بجوهر الصورة الأصلية مع السعي إلى هذا الاتجاه البصري: **تحويل قصة الصورة غير المنطوقة إلى حكاية مصوّرة دافئة وطفولية وذكية**. يبدأ من الاستخدام المقصود والنتيجة المطلوبة، ثم يحدد التكوين والمقاس والنص وصيغة التسليم.
...
> استخدم XXD Panel 059 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## تحقق سريع: هل XXD Panel 059 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | تحويل قصة الصورة غير المنطوقة إلى حكاية مصوّرة دافئة وطفولية وذكية |
| **السمات التي تُعرف من النظرة الأولى** | سرد مرسوم يدوياً · استعارة طفولية · ورق دافئ · فكاهة رقيقة · تعليق شاعري |
...
يفهم الأسلوب أولاً الصورة المركزية والمعنى الضمني والجو، ثم يحتفظ بالموضوع والهيئة والحركة والعلاقة المكانية الأكثر قابلية للتعرّف. يسمح بالمقياس المبالغ فيه والتشخيص والمشهد الاستعاري، لكن كل ذلك يخدم فكرة مركزية واحدة ولا يتحول إلى تراكم لعناصر لطيفة بلا صلة.

```text
تثبيت الهوية والهيئة والحركة ← فهم المعنى الضمني والجو والدلالة ← حذف التفاصيل الواقعية التي لا تخدم السرد ← إعادة صياغة العلاقات بالمقياس والتشخيص والمشهد الاستعاري ← إنماء خيال صغير داخل فراغ فاتح وعمق منحني ← رسمه بدفء الغواش والباستيل والقلم والطباشير ← دمج ملاحظة شعرية أو تعليق ذكي
```

## سمات الأسلوب التي تظهر بوضوح في النتيجة

- تبقى العلاقة البصرية الأكثر جوهرية وجديرة بالتذكّر، فيظل الأصل قابلاً للتعرّف وتظهر عاطفته ومعناه الخفيان.
- تصنع الخطوط غير المتقنة قليلاً والمساحات الناعمة وخامة المواد الطبيعية والأخطاء اليدوية الصغيرة سطحاً حنوناً غير تجاري لكتاب مصوّر.
- يضيف المقياس المبالغ فيه والتشخيص والرموز المتكررة والمشهد الاستعاري براءة وفكاهة خفيفة من دون مغادرة موضوع الصورة.
- يحافظ الأزرق الوردي الفاتح والأزرق الضبابي والكريمي والبيج الفاتح والأخضر الهادئ ولمسات الوردي على جو خفيف ومريح.
- يستقر الموضوع غالباً في الجزء الأوسط السفلي أو عند نقطة توتر سردي، وتدخل الملاحظة الشعرية الفراغ كتعليق ذكي لا كتفسير مباشر.

لا توجد القيود الجمالية وقواعد الرفض إلا في [الموجّه الأصلي](references/original-prompt/zh-CN.md)، أما المهارة ومهايئ التشغيل فيعالجان متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-059-prompt.en.md)
...
/xxd-panel-059 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-059 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-059 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-059 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-059 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 059 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-059 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-059`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-059-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-059-prompt.zh-CN.md)
