...
# 🦁 XXD Panel 059｜手描き寓話録

### 写真に言葉にならなかった物語を、温かく童心のある賢い寓話絵本へ
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092183407778509243"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 059 作例 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2092183407778509243"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 059 作例 2"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 059 作例 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 059 作例 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 059 作例 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 059 作例 8"></td>
  </tr>
</table>

## 追加 3:4 上下構成作例

上の 16:9 作例と同じ4点の独立素材を、完全な 3:4 上下構成として再生成しました。上部は現実の写真を保ち、下部は Panel 059 の原文プロンプトに従って再構成しています。英語コピーは各写真の内容・空気・含意だけから生成し、全点を個別に確認しました。

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 059 追加上下作例 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 059 追加上下作例 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 059 追加上下作例 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 059 追加上下作例 4"></td>
  </tr>
</table>

> [小小東（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2092183407778509243) · 2026年8月25日<br>
> GPT2 × 絵本 × 童心 × イラストレーション × 美学プロンプト × VOL.059

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2092183407778509243">元の投稿と完全なプロンプトを見る →</a></p>

これらの作例は 059 の美的成果だけを示します。作例の被写体、構図、配色、文字、旧キャンバス比率が、新しいタスクの参照や既定値になることはありません。

手描きの物語 · 童心の比喩 · 温かな紙感 · ほのかなユーモア · 詩的な傍白
...
**Panel 059** は、原写真の核を保ちながら、次の視覚方向を目指す制作に向いています：**写真に言葉にならなかった物語を、温かく童心のある賢い寓話絵本へ**。まず用途と期待する結果を確認し、そこから構図、サイズ、文字、納品形式を決めます。
...
> XXD Panel 059 でこの画像を処理して、まず最適な構図とサイズを提案して。
...
| 知りたいこと | このスタイルの答え |
|---|---|
| **得られる完成作品** | 写真に言葉にならなかった物語を、温かく童心のある賢い寓話絵本へ |
| **ひと目で分かる特徴** | 手描きの物語 · 童心の比喩 · 温かな紙感 · ほのかなユーモア · 詩的な傍白 |
...
写真の核となるイメージ、潜台詞、空気を理解し、最も識別しやすい主体、輪郭、身振り、空間関係だけを残します。誇張された比率、擬人化、比喩的な景物を使えますが、すべては一つの中心テーマに仕え、無関係な「かわいい」要素の山にはしません。

```text
同一性・輪郭・身振りを固定 → 潜台詞・空気・寓意を理解 → 物語に不要な現実の細部を削る → 比率の誇張・擬人化・比喩的景物で関係を語り直す → 淡い余白と曲線的な奥行きから小さな幻想を育てる → ガッシュ・パステル・色鉛筆・クレヨンの温かさで描く → 詩的な注記や賢い傍白を統合
```

## 完成作品で見分けやすいスタイル特性

- 最も本質的で記憶に残る図像関係だけを残し、原物の識別性を保ちながら隠れた感情と意味を見せます。
- 少し不器用な輪郭、柔らかな色面、自然素材の質感、小さな手作業の揺れが、商業的すぎない優しい絵本の表面を作ります。
- 誇張された比率、擬人化、反復記号、比喩的な景物が、元写真のテーマを離れずに童心と軽いユーモアを加えます。
...
画像フォルダーを直接渡すと、この兵士 Skill が同じ Panel 059 の原文美学で一括処理します。一般的なラスター形式を既定で再帰検索し、件数を報告してから、モード・サイズ・文字・言語を一度だけ確認します。各画像は内容や文言を混ぜず独立生成し、バッチ全体は一つのフラットなタスクフォルダーへ保存します。個別の失敗は記録し、後続画像を黙って省略しません。
...
/xxd-panel-059 photo.jpg --mode top-bottom --size auto --text prompt --locale ja-JP
...
/xxd-panel-059 photo.jpg --mode design-only --size 3:4 --text prompt --locale ja-JP

# 正確な文言を、書き換え・翻訳・タイトル追加なしで使用
/xxd-panel-059 photo.jpg --mode design-only --size 3:4 --copy "光をここに残す" --locale ja-JP

# 2モード × 3サイズで独立した完成構図を6枚生成
/xxd-panel-059 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ja-JP

# フォルダー全体へ Panel 059 を適用し、共通設定は一度だけ解決
/xxd-panel-059 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ja-JP
...
Claude Code では同じフォルダを次へリンクできます： `~/.claude/skills/xxd-panel-059`. インストール後に Agent セッションを再起動してください。
